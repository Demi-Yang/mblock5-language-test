...
class AurigaTest(unittest.TestCase):
    ...
    def test_auriga_no_new_or_missing_items(self):
        self.assertEqual(len(self.test_dict), 208, "auriga 模块下存在新增或者删减的字段，需要修改测试用例！")
    ...
    def test_AURIGA_SOUND_PLAY_NOTE_NOTE(self):
        self.check_param('AURIGA_SOUND_PLAY_NOTE_NOTE_0', "C2")
        self.check_param('AURIGA_SOUND_PLAY_NOTE_NOTE_1', "D2")
        self.check_param('AURIGA_SOUND_PLAY_NOTE_NOTE_2', "E2")
        self.check_param('AURIGA_SOUND_PLAY_NOTE_NOTE_3', "F2")
        self.check_param('AURIGA_SOUND_PLAY_NOTE_NOTE_4', "G2")
        self.check_param('AURIGA_SOUND_PLAY_NOTE_NOTE_5', "A2")
        self.check_param('AURIGA_SOUND_PLAY_NOTE_NOTE_6', "B2")
        self.check_param('AURIGA_SOUND_PLAY_NOTE_NOTE_7', "C3")
        self.check_param('AURIGA_SOUND_PLAY_NOTE_NOTE_8', "D3")
        self.check_param('AURIGA_SOUND_PLAY_NOTE_NOTE_9', "E3")
        self.check_param('AURIGA_SOUND_PLAY_NOTE_NOTE_10', "F3")
        self.check_param('AURIGA_SOUND_PLAY_NOTE_NOTE_11', "G3")
        self.check_param('AURIGA_SOUND_PLAY_NOTE_NOTE_12', "A3")
        self.check_param('AURIGA_SOUND_PLAY_NOTE_NOTE_13', "B3")
        self.check_param('AURIGA_SOUND_PLAY_NOTE_NOTE_14', "C4")
        self.check_param('AURIGA_SOUND_PLAY_NOTE_NOTE_15', "D4")
        self.check_param('AURIGA_SOUND_PLAY_NOTE_NOTE_16', "E4")
        self.check_param('AURIGA_SOUND_PLAY_NOTE_NOTE_17', "F4")
        self.check_param('AURIGA_SOUND_PLAY_NOTE_NOTE_18', "G4")
        self.check_param('AURIGA_SOUND_PLAY_NOTE_NOTE_19', "A4")
        self.check_param('AURIGA_SOUND_PLAY_NOTE_NOTE_20', "B4")
        self.check_param('AURIGA_SOUND_PLAY_NOTE_NOTE_21', "C5")
        self.check_param('AURIGA_SOUND_PLAY_NOTE_NOTE_22', "D5")
        self.check_param('AURIGA_SOUND_PLAY_NOTE_NOTE_23', "E5")
        self.check_param('AURIGA_SOUND_PLAY_NOTE_NOTE_24', "F5")
        self.check_param('AURIGA_SOUND_PLAY_NOTE_NOTE_25', "G5")
        self.check_param('AURIGA_SOUND_PLAY_NOTE_NOTE_26', "A5")
        self.check_param('AURIGA_SOUND_PLAY_NOTE_NOTE_27', "B5")
        self.check_param('AURIGA_SOUND_PLAY_NOTE_NOTE_28', "C6")
        self.check_param('AURIGA_SOUND_PLAY_NOTE_NOTE_29', "D6")
        self.check_param('AURIGA_SOUND_PLAY_NOTE_NOTE_30', "E6")
        self.check_param('AURIGA_SOUND_PLAY_NOTE_NOTE_31', "F6")
        self.check_param('AURIGA_SOUND_PLAY_NOTE_NOTE_32', "G6")
        self.check_param('AURIGA_SOUND_PLAY_NOTE_NOTE_33', "A6")
        self.check_param('AURIGA_SOUND_PLAY_NOTE_NOTE_34', "B6")
        self.check_param('AURIGA_SOUND_PLAY_NOTE_NOTE_35', "C7")
        self.check_param('AURIGA_SOUND_PLAY_NOTE_NOTE_36', "D7")
        self.check_param('AURIGA_SOUND_PLAY_NOTE_NOTE_37', "E7")
        self.check_param('AURIGA_SOUND_PLAY_NOTE_NOTE_38', "F7")
        self.check_param('AURIGA_SOUND_PLAY_NOTE_NOTE_39', "G7")
        self.check_param('AURIGA_SOUND_PLAY_NOTE_NOTE_40', "A7")
        self.check_param('AURIGA_SOUND_PLAY_NOTE_NOTE_41', "B7")
        self.check_param('AURIGA_SOUND_PLAY_NOTE_NOTE_42', "C8")
        self.check_param('AURIGA_SOUND_PLAY_NOTE_NOTE_43', "D8")
