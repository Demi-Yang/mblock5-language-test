...
# ======================  auriga_variety_gizmos項目-翻译检查  =======================

class AurigaVarietyGizmosTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.test_dict = test_file['ext-i18n/auriga_variety_gizmos']

    # ext-i18n/auriga_variety_gizmos/No empty value
    def test_ext_i18n_auriga_variety_gizmos_no_empty_value(self):
        for key,value in self.test_dict.items():
            self.assertIsNotNone(value)
            self.assertNotEqual(value, '')

    # ext-i18n/auriga_variety_gizmos/No new or missing items
    def test_ext_i18n_auriga_variety_gizmos_no_new_or_missing_items(self):
    ...
    def test_ext_i18n_auriga_variety_gizmos_mcore_show_external_led_time(self):
    ...
    def test_ext_i18n_auriga_variety_gizmos_mcore_show_external_led(self):
    ...
    def test_ext_i18n_auriga_variety_gizmos_mcore_show_external_led_rgb(self):
    ...
    def test_ext_i18n_auriga_variety_gizmos_mcore_run_servo(self):
    ...
    def test_ext_i18n_auriga_variety_gizmos_mcore_event_limit_switch(self):
...
if __name__ == "__main__":
    ...
    # #此用法可以同时测试多个类
    suite1 = unittest.TestLoader().loadTestsFromTestCase(AurigaVarietyGizmosTest) 
